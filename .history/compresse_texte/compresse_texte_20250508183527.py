...
# fonction qui convertit du texte en liste de mots
def convertirTexteEnListeDeMots(texte):
    return texte.split(" ")

# fonction qui convertit liste de mots en texte
def reconvertirListeDeMotsEnTexte(listeDeMots):
    return " ".join(listeDeMots)

# fonction qui compresse une liste de mots
...
# fontion qui compresse du texte
