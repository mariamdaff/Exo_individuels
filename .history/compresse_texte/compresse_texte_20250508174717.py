...
#fonction pour decouper du texte en liste de mots
...
print("Texte decoupé en liste de mots: ",liste_de_mots)
#fonction qui reconstruitune liste de mot en chain de caractere
...
print("Liste de mots convertie en chaine de caracteres: ", texte_reconvertie)

# fonction qui permet de compresser des mots
...
mots_compresses =compresser_mots(liste_de_mots, mon_dictionnaire)
print("Liste de mots compresses: \n ", mots_compresses)